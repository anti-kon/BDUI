...
export type WebComponentRenderer<TNode extends ComponentNode = ComponentNode> = (params: ComponentRendererParams<TNode, WebRendererContext>) => HTMLElement;
/** Native renderer extension points used by platform-specific packages. */
export interface AndroidRendererContext {
    readonly platform: 'android';
}
export type AndroidComponentRenderer<TNode extends ComponentNode = ComponentNode> = (params: ComponentRendererParams<TNode, AndroidRendererContext>) => unknown;
export interface IosRendererContext {
    readonly platform: 'ios';
}
export type IosComponentRenderer<TNode extends ComponentNode = ComponentNode> = (params: ComponentRendererParams<TNode, IosRendererContext>) => unknown;

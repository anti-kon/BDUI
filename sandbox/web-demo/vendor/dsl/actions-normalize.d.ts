import type { Action, ExprRef, HttpMethod, StateTarget, ToastLevel } from '@bdui/core';
...
export type ShortAction = Action | {
    ...
    readonly toast: readonly [string, {
        level?: ToastLevel;
        durationMs?: number;
    }?];
} | {
    ...
    readonly batch: readonly ShortAction[];

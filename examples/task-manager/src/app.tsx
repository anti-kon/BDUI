...
const subtitle = { color: themeColor('#5b677a', '#b7c4d6'), lineHeight: 1.55, maxWidth: 720 };
const eyebrow = {
...
const sectionTitle = { fontSize: 18, fontWeight: 800, color: themeColor('#101827', '#f1f5f9') };
const metricValue = { fontSize: 26, fontWeight: 800, color: themeColor('#16213a', '#e2e8f0') };
const muted = { color: themeColor('#6b7688', '#a9b6c8') };
const success = { color: themeColor('#047857', '#5eead4'), fontWeight: 700 };
const warning = { color: themeColor('#b45309', '#fbbf24'), fontWeight: 700 };
const danger = { color: themeColor('#b91c1c', '#fca5a5'), fontWeight: 700 };
const pill = {

...
| Automated local verification                                        | Complete                                          | `npm run verify:all`, including standalone Taskly typecheck and bundles                                                                               |
...
| Cross-browser visual smoke                     | Chromium and WebKit passed locally; Firefox blocked by Windows sandbox graphics launch | CI installs Playwright browsers and runs `npm run verify:browsers`                                                     |

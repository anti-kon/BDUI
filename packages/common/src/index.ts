...
export type FlowTransition = { to: string; guard?: string };
...
export type Navigation = { initialRoute: string; urlSync?: boolean; routes: Array<AppRoute> };
